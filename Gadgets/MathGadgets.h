...
namespace Loopring
{
    ...
    public:
        ...
        Constants(
            ProtoboardT &pb,
            const std::string &prefix) : GadgetT(pb, prefix),
    ...
    public:
        ...
        SignatureVerifier(
            ...
            bool _requireValid = true) : GadgetT(pb, prefix),
    ...
    public:
        DualVariableGadget(
            ProtoboardT &pb,
            const size_t width,
            const std::string &prefix) : libsnark::dual_variable_gadget<FieldT>(pb, width, prefix)
        {
        }
